...
class ProcessWindow(QDialog):
  ...
  def setup_form(self):
      ...
      self.layout.addRow(label_midi_folder, self.midi_folder_input)
      ...
      self.layout.addRow(label_output_midi, self.output_file_input)

      browser_button_output = QPushButton('Browser...')
      browser_button_output.pressed.connect(self.set_output_file)
      self.layout.addWidget(browser_button_output)
